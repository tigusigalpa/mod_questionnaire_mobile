 ...
 */
.factory('$mmaModQuestionnaireHandlers', function($mmCourse, $mmaModQuestionnaire, $state, $mmContentLinksHelper, $mmUtil, $mmEvents, $mmSite, $q,
            $mmCoursePrefetchDelegate, mmCoreDownloading, mmCoreNotDownloaded, mmCoreOutdated,
            mmCoreEventPackageStatusChanged, mmCoreDownloaded) {
    var self = {};
